...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Answer:
    # It modifies the original string, and does not leave memory leaks or hanging variables.
    # It also flows more naturally.
    #
    # Also, I believe you can use the shovel operator more than once in a line of code.
  end
  ...
  def test_single_quotes_sometimes_interpret_escape_characters
    ...
    assert_equal 2, string.size
    assert_equal "\\'", string
    # Gotcha:  The first \ disappears.  Why?
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Yes I am.  It's the character to number.  *NOT* a string!
  end
  ...
  def test_strings_can_be_joined
    ...
    # Note that the argument to join() is the pattern by which separation occurs.  In this case, it's space.
  end
