...
class AboutMessagePassing < EdgeCase::Koan
  ...
  # NOTE:  The method name is a symbol.
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Answer:  send() is a method in root class Object.
    # I can think of a myriad of situations where send() would be used as a completely
    # different function, so __send__() is retained so it's never overloaded.
  end
