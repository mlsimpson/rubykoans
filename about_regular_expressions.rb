...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Answer:  When you're dealing with arrays or hashes
    # IE:  assert_equal __, ["abcd", "efgh"][/z*/]
  end
  ...
  #
  # Why?
  # Answer:  It eats the first match, and only the first match.
  ...
  # Gotcha:  The colon in "Name:" does not match the word.
  # This is due to a word being "[a-zA-Z0-9]"
  ...
  def test_a_vertical_pipe_means_or
    ...
    # Gotcha:  grays expression is James Gray, Dana Gray, Summer Gray
  ...
  # Answer:  A character class matches a range of characters, while an alternation matches specific instances within.

  # ------------------------------------------------------------------

  def test_scan_is_like_find_all
    assert_equal ["one", "two", "three"], "one two-three".scan(/\w+/)
    # Gotcha:  .scan returns an array
  end
  ...
  # Gotcha:  $1[0, 1] does not include a space.  It's the whole string, w/out spaces, given the sub/gsub
end
