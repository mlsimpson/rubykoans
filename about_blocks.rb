...
class AboutBlocks < EdgeCase::Koan
  ...
  # NOTE:  &standaloneblock is passing the block to the function.
  # method_with_block_arguments yields "Jim".
  # The block passed to method_with_block_arguments takes the yielded result
  # and makes it uppercase, as per its block code.
