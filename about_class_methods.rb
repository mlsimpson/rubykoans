...
class AboutClassMethods < EdgeCase::Koan
  ...
  # NOTE:  An object is an *instantiated* class.
  # Remember - instance methods/variables exist for INSTANTIATED classes (aka objects
  # made from the class), while class methods exist for the class itself as well.
  # Class methods/variables affect each instantiated object.
  ...
  # NOTE:  This is interesting and critical.
  ...
  # NOTE:  This is a critical gem of knowledge to understand.
  # Pay attention to the fact that the class level methods/variables take precedence over
  ...
  #
  # ANSWER:  I prefer the << methodology, since it's easy to quickly recognize.
  # If I'm writing only 1 class method, I'd use the former.
  # If I'm writing many class methods, I'd use the latter.
